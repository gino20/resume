  ...
  career: [
    {
      ...
      during: '2014年10月 ~ 2017年7月',
      post: '前端开发',
      projects: [
        `官网项目: ruby on rails 框架, 
        对页面erb模板进行开发和维护, 
        使用 sass + bootstrap 组织样式`,
        `官网重构项目: angular + gulp, 
        完成官网所有页面, 其中包括鉴权功能, 使用开源播放器完成站内视频的播放, 接入三方插件完成线上支付功能等`,
        `直播项目: webpcak + react + redux, 使用 ES6 的语法, 完成大部分页面, 能合理组织 component, 使用 postcss 处理样式, 
        使用 redux 进行项目数据流管理, 使用开源播放器完成直播视频的播放, 接入三方的客服功能, 通过 iframe 与原项目进行合并.`,
        `官网重构项目: webpack + react + mobx, 自主开发轮播图和模态窗等组件, 使用 docker 进行容器化管理.`
      ]
    },
    {
